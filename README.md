...
This package is a continuation of the routines available at https://github.com/MigueBeneito/pNimble. Earlier versions of these routines were numbered `0.1`, `0.2`, and `0.3`, and the version history below starts at `0.4.0` with their development as an `R` package.
...
* `pNimble()`, a function to run independent `NIMBLE` MCMC chains in parallel and return posterior samples with optional summaries, WAIC, notifications, and total computation time.
